...
import { getCompanyId, hasPermission } from '../utility/authUtils';
    ...
    <IonMenu contentId="main-content" type="overlay" className="custom-sidebar">
      <IonContent className="ion-no-padding">
        ...
        <IonList id="nav-list" lines="none">
              ...
              <IonAccordion value="sales" className="sidebar-accordion">
                ...
                <div slot="content" className="sub-menu">
                  ...
                  <IonItem routerLink="/dashboard/finance/debit-notes" className="sub-nav-item">
                   ...
                   <IonItem routerLink="/dashboard/finance/receipts" className="sub-nav-item">
                    <IonLabel>Payment Receipt</IonLabel>
                  </IonItem>
                </div>
              </IonAccordion>
            </IonAccordionGroup>
          ...
          {/* Staff Items*/}
          {hasPermission("Staff & Technician") && (
            <IonAccordionGroup>
              <IonAccordion value="staff" className="sidebar-accordion">
                <IonItem slot="header" className="nav-item">
                  <span slot="start">
